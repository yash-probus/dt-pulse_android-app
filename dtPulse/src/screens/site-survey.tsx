...
import {  MapPin, CircleCheck  } from '@/utils/icons';
...
export default function SiteSurveyScreen() {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.background }}>
      <AppHeader title="Site Survey" back />
      <ScrollView contentContainerStyle={{ paddingTop: headerH + 40, paddingHorizontal: 24, alignItems: 'center' as const, paddingBottom: insets.bottom + 40 }}>
        ...
        <Text style={{ fontSize: 24, fontWeight: '700' as const, color: colors.foreground, fontFamily: 'Inter_700Bold', marginBottom: 8 }}>Site Survey</Text>
