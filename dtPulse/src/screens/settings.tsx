...
import {  Bluetooth, Moon, RefreshCw, CloudUpload, ChevronRight, Info, LogOut  } from '@/utils/icons';
import { router } from '@/utils/router';
import { useApp } from '@/context/AppContext';
import useColors from '@/hooks/useColors';
import { AppHeader } from '@/components/AppHeader';

function SettingRow({ icon: Icon, label, desc, value, onChange, colors }: any) {
  return (
    ...
    <View style={s.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={s.scroll}>
        ...
        <View style={s.section}>
          ...
          <SettingRow icon={RefreshCw} label="Sync Settings" desc="Auto-sync logs when online" value={autoSync} onChange={setAutoSync} colors={colors} />
