...
import {  Info, RefreshCw, Cpu, Package, Battery, Thermometer, Wifi, CircleAlert, CircleCheck, Share2, BarChart2  } from '@/utils/icons';
...
function ReadRow({ label, value, icon: Icon, colors }: any) {
  return (
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={s.scroll} keyboardShouldPersistTaps="handled">
        ...
        <View style={s.statusCard}>
          ...
          {isSet && (
            ...
            >
              <RefreshCw size={13} color={colors.foreground} />
        ...
        <View style={s.sectionCard}>
          ...
          <ReadRow label="Error Status" value={errorStatus} icon={isError ? CircleAlert : CircleCheck} colors={{ ...colors, accent: isError ? colors.destructive : colors.success }} />
          <ReadRow label="BLE Network" value={device.config.bleNetwork} icon={Share2} colors={colors} />
          <ReadRow label="Analog Values" value={device.config.analogValues.join(' / ')} icon={BarChart2} colors={colors} />
        </View>
