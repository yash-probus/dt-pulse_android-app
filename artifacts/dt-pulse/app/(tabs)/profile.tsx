            ...
            {pwStep === 'done' ? (
              ...
              <>
                ...
                <View style={s.inputRow}>
                  ...
                  <Pressable onPress={() => setShowOld(!showOld)} hitSlop={8}><Ionicons name={showOld ? 'eye-off-outline' : 'eye-outline'} size={18} color={colors.mutedForeground} /></Pressable>
                </View>
              ...
              <>
                ...
                <View style={s.inputRow}>
                  ...
                  <Pressable onPress={() => setShowNew(!showNew)} hitSlop={8}><Ionicons name={showNew ? 'eye-off-outline' : 'eye-outline'} size={18} color={colors.mutedForeground} /></Pressable>
                </View>
                <View style={s.inputRow}>
